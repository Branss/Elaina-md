...
• DikaArdnt 
https://github.com/DikaArdnt (MASTAH)
• Fatih
https://github.com/FatihArridho (MASTAH)
• SkylarKaf
https://github.com/SkylarKaf (MASTAH)
• Deff
https://github.com/DEFF-Y` (MASTAH)
reply(efhzm)}
   break
         ...
         hydratedTemplate: {
           ...
           hydratedContentText: `*• Information* `,
               hydratedFooterText: anu,
                            hydratedButtons: [
                            { urlButton: { displayText: 'Profile', url: 'https://s.id/Skylarkaf' } }, 
                            { urlButton: { displayText: 'Source Code', url: 'nekopoi.care' } }, 
